...
from python_oop.testing.cat.cat import Cat
...
class TestCat(TestCase):
    ...
    def test_feed_cat_make_cat_sleepy_and_not_hungry_expect_size_increase_by_one(self):
    ...
    def test_sleepy_cat_sleep_and_its_not_sleepy_after_that(self):
